module Carmen
  ...
  # The Legacy module supplies the API used by all version of Carmen up
  # through 0.3.
  module Legacy
    def self.included(base)
      ...
      base.default_country = 'us'
      base.default_locale = :en
      base.excluded_countries = []
      base.excluded_states = {}
      base.priority_countries = []

      # base.data_path = File.join(File.dirname(__FILE__), '..', 'data')

      # base.states = Dir[File.join(@data_path, '/states/*.yml')].map do |file_name|
    ...
    module API
      ...
      def state_name(state_code, country_code = Carmen.default_country, options={})
      ...
      def state_code(state_name, country_code = Carmen.default_country, options={})
      ...
      def state_names(country_code = Carmen.default_country, options={})
      ...
      def state_codes(country_code = Carmen.default_country)
      ...
      def states(country_code = Carmen.default_country, options={})
